...
export const menuItems: MenuItem[] = [
  ...
  // SOBREMESAS
  // ═══════════════════════════════════════════════════════════════════════════
  { id: 'dessert-chocolate-fondant', categoryId: 'desserts', name: { pt: 'Fondant de Chocolate', en: 'Chocolate Fondant', fr: 'Fondant au Chocolat', zh: '巧克力熔岩蛋糕' }, description: { pt: '', en: '', fr: '', zh: '' }, price: 800, image: '/menu/placeholder-dessert.jpg', tags: [], available: true },
  ...
  { id: 'dessert-latina-split', categoryId: 'desserts', name: { pt: 'Latina Split', en: 'Latina Split', fr: 'Latina Split', zh: 'Latina 香蕉船' }, description: { pt: '', en: '', fr: '', zh: '' }, price: 900, image: '/menu/placeholder-dessert.jpg', tags: ['signature'], available: true },
