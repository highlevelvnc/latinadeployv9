...
export const categories: MenuCategory[] = [
  ...
  { id: 'vegetarian', name: { pt: 'Opções Vegetarianas', en: 'Vegetarian Options', fr: 'Options Végétariennes', zh: '素食' }, icon: 'Leaf', sortOrder: 13 },
  { id: 'gold-selection', name: { pt: 'Golden Selection', en: 'Golden Selection', fr: 'Sélection Golden', zh: '黄金甄选' }, icon: 'Crown', sortOrder: 14 },
...
export const menuItems: MenuItem[] = [
  ...
  },
  {
    ...
    categoryId: 'couvert',
    name: {
      pt: 'Croquetes de Novilho (3 unidades)',
      en: 'Beef Croquettes (3 pcs)',
      fr: 'Croquettes de Bœuf (3 pcs)',
      zh: '牛肉可乐饼（3件）',
    },
    description: { pt: '', en: '', fr: '', zh: '' },
    price: 780,
    image: '/menu/beef-croquettes.png',
    tags: ['bestseller'],
    available: true,
  },
  {
  ...
  },
  {
    ...
    name: {
      ...
      fr: "Foie Gras de Frankie – Signature du Chef",
      zh: "Frankie 主厨招牌鹅肝",
    },
    description: { pt: '', en: '', fr: '', zh: '' },
    price: 1700,
  ...
  },
  {
    ...
    description: { pt: '', en: '', fr: '', zh: '' },
    price: 900,
    image: '/menu/egg-croutons-truffle.png',
    tags: [],
    available: true,
  },
  {
  ...
  },
  {
    ...
    price: 1050,
    image: '/menu/kids-cheeseburger.png',
    tags: [],
    available: true,
  },
  ...
  },
  {
    ...
    price: 14500,
    priceUnit: '/kg',
    image: '/menu/tomahawk-wagyu-australia.png',
  ...
  },
  {
    ...
    price: 15500,
    priceUnit: '/kg',
    image: '/menu/tomahawk-australia-cognac-madeira.png',
    tags: ['premium', 'signature'],
    available: true,
  },
  {
  ...
  },
  {
    ...
    description: { pt: '', en: '', fr: '', zh: '' },
    price: 18000,
    image: '/menu/rib-eye-usa-250g.png',
    tags: ['premium'],
    available: true,
  },
  ...
  },
  {
    ...
    description: { pt: '', en: '', fr: '', zh: '' },
    price: 2900,
    image: '/menu/filet-mignon-200g.png',
    tags: ['bestseller'],
    available: true,
  },
  {
  ...
  },
  {
    ...
    description: { pt: '', en: '', fr: '', zh: '' },
    price: 3600,
    image: '/menu/sirloin-australia-250g.png',
    tags: ['premium'],
    available: true,
  },
  {
  ...
  },
  {
    ...
    description: {
      pt: 'Marinada 24 horas e cozinha 6 horas no bafo e 6 horas no forno.',
      en: 'Marinated 24 hours, slow-steamed for 6 hours and finished in the oven for 6 hours.',
      fr: 'Marinée 24 heures, cuite 6 heures à la vapeur et terminée 6 heures au four.',
      zh: '腌制 24 小时，慢蒸 6 小时，再烤箱完成 6 小时。',
    },
    price: 4500,
    image: '/menu/short-ribs-12h.png',
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    description: {
      pt: 'Picanha Austrália 250 gr / Entrecôte 250 gr / T-Bone 500 gr / Vazia Black Angus 250 gr / Plumas Porco Preto com Cereja Basca em Porto. Com 3 guarnições à escolha (exceto Batata Dourada e Puré Trufado).',
      en: 'Australian Picanha 250g / Entrecôte 250g / T-Bone 500g / Black Angus Sirloin 250g / Iberian Pork Plumas with Basque Cherry in Port. With 3 sides of your choice (except Golden Potatoes and Truffled Mashed Potato).',
      fr: 'Picanha Australie 250g / Entrecôte 250g / T-Bone 500g / Rumsteck Black Angus 250g / Plumas de Porc Ibérique à la Cerise Basque au Porto. Avec 3 accompagnements au choix (sauf Pommes Dorées et Purée Truffée).',
      zh: '澳洲臀盖肉 250克 / 肉眼 250克 / 丁骨 500克 / 黑安格斯西冷 250克 / 伊比利亚黑猪肉配巴斯克樱桃波特酒。含 3 份配菜（不含金黄土豆与松露土豆泥）。',
    },
    price: 15250,
    image: '/menu/latina-premium-board.png',
  ...
  },
  {
    ...
    description: {
      pt: 'Rib Eye Maturado 500 gr / Filet 250 gr / Plumas Porco Preto / Supremo de Frango. Com 3 guarnições à escolha (exceto Batata Dourada e Puré Trufado).',
      en: 'Aged Rib Eye 500g / Filet 250g / Iberian Pork Plumas / Chicken Supreme. With 3 sides of your choice (except Golden Potatoes and Truffled Mashed Potato).',
      fr: 'Rib Eye Maturé 500g / Filet 250g / Plumas de Porc Ibérique / Suprême de Poulet. Avec 3 accompagnements au choix (sauf Pommes Dorées et Purée Truffée).',
      zh: '熟成肋眼 500克 / 菲力 250克 / 伊比利亚黑猪肉 / 鸡胸肉。含 3 份配菜（不含金黄土豆与松露土豆泥）。',
    },
    price: 18300,
  ...
  },
  {
    ...
    description: {
      pt: 'Chuletón Rubia Gallega Gold 1 kg / T-Bone 0,8 kg / Tomahawk 1 kg. Com 4 guarnições à escolha (exceto Batata Dourada e Puré Trufado).',
      en: 'Rubia Gallega Gold Chuletón 1kg / T-Bone 0.8kg / Tomahawk 1kg. With 4 sides of your choice (except Golden Potatoes and Truffled Mashed Potato).',
      fr: 'Chuletón Rubia Gallega Gold 1kg / T-Bone 0,8kg / Tomahawk 1kg. Avec 4 accompagnements au choix (sauf Pommes Dorées et Purée Truffée).',
      zh: 'Rubia Gallega Gold 带骨牛排 1公斤 / 丁骨 0.8公斤 / 战斧牛排 1公斤。含 4 份配菜（不含金黄土豆与松露土豆泥）。',
    },
    price: 29800,
  ...
  },
  {
    ...
    description: {
      pt: 'Lagosta / Camarão Tigre / Tomahawk Australiano Wagyu 1 kg. Com guarnições à escolha (exceto Batata Dourada e Puré Trufado).',
      en: 'Lobster / Tiger Prawn / Australian Wagyu Tomahawk 1kg. With sides of your choice (except Golden Potatoes and Truffled Mashed Potato).',
      fr: 'Langouste / Crevette Tigre / Tomahawk Wagyu Australien 1kg. Avec accompagnements au choix (sauf Pommes Dorées et Purée Truffée).',
      zh: '龙虾 / 虎虾 / 澳洲和牛战斧牛排 1公斤。含配菜（不含金黄土豆与松露土豆泥）。',
    },
    price: 30000,
  ...
  },
  {
    ...
    categoryId: 'side-dishes',
    name: {
      pt: 'Batata Doce Frita com Alho e Oregãos e Aioli Trufado',
  ...
  },
  {
    ...
    description: { pt: '', en: '', fr: '', zh: '' },
    price: 780,
    image: '/menu/grilled-vegetables.png',
    tags: [],
    available: true,
  },
  {
  ...
  },
  {
    ...
    description: { pt: '', en: '', fr: '', zh: '' },
    price: 12000,
    image: '/menu/golden-rib-eye-500g.png',
    tags: ['gold', 'premium'],
    available: true,
  },
  {
    ...
    description: { pt: '', en: '', fr: '', zh: '' },
    price: 40000,
    image: '/menu/golden-japanese-wagyu-300g.png',
  ...
  },
  {
    ...
    price: 19000,
    priceUnit: '/kg',
    image: '/menu/golden-australian-wagyu-tomahawk.png',
  ...
  },
  {
    ...
    categoryId: 'sauces',
    name: {
      pt: 'Mostarda Francesa e Vinho Madeira',
      en: 'French Mustard and Madeira Wine',
      fr: 'Moutarde Française et Vin de Madère',
      zh: '法式芥末与马德拉酒',
    },
    description: { pt: '', en: '', fr: '', zh: '' },
    price: null,
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    description: {
      pt: 'Corte premium de Wagyu Japonês A5, reconhecido mundialmente pelo seu extraordinário marmoreado e textura extremamente macia. Grelhado cuidadosamente na brasa para realçar o sabor e a suculência da carne. Acompanha Batata Trufada e Legumes Grelhados.',
    ...
    price: 15000,
    image: '/menu/chef-kobe-a5-bife-150g.png',
  ...
  },
  {
    ...
    price: 14500,
    priceUnit: '/kg',
    image: '/menu/placeholder-chef.jpg',
  ...
  // SOBREMESAS
  // ═══════════════════════════════════════════════════════════════════════════
  { id: 'dessert-chocolate-fondant', categoryId: 'desserts', name: { pt: 'Fondant de Chocolate', en: 'Chocolate Fondant', fr: 'Fondant au Chocolat', zh: '巧克力熔岩蛋糕' }, description: { pt: '', en: '', fr: '', zh: '' }, price: 800, image: '/menu/dessert-chocolate-fondant.png', tags: [], available: true },
  ...
  { id: 'dessert-latina-split', categoryId: 'desserts', name: { pt: 'Latina Split', en: 'Latina Split', fr: 'Latina Split', zh: 'Latina 香蕉船' }, description: { pt: '', en: '', fr: '', zh: '' }, price: 900, image: '/menu/dessert-latina-split.png', tags: ['signature'], available: true },
  ...
  { id: 'dessert-banoffee-pie', categoryId: 'desserts', name: { pt: 'Banoffee Pie', en: 'Banoffee Pie', fr: 'Banoffee Pie', zh: '香蕉太妃派' }, description: { pt: '', en: '', fr: '', zh: '' }, price: 800, image: '/menu/dessert-banoffee-pie.png', tags: [], available: true },
