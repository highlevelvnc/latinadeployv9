...
export default function EventsSection() {
  ...
  const content = {
    ...
    ru: {
      badge: 'Частные мероприятия',
      overallTitle: 'Запоминающиеся торжества',
      cta: 'Спланировать мероприятие',
      events: [
        {
          label: 'Дни рождения и свадьбы',
          title: 'Торжества, остающиеся в памяти',
          description:
            'Уникальные дни заслуживают уникальных пространств. Мы создаём идеальную атмосферу для дней рождения и свадеб: эксклюзивное меню, индивидуальное оформление и безупречный сервис.',
        },
        {
          label: 'Корпоративные мероприятия',
          title: 'Корпоративные ужины и конференции',
          description:
            'От делового ужина до корпоративной конференции — отдельное пространство до 150 гостей с безупречным сервисом, техническим оснащением и меню, адаптированным под каждый случай.',
        },
        {
          label: 'Особые торжества',
          title: 'Моменты, достойные лучшего',
          description:
            'Какой бы ни была причина, мы гарантируем впечатление, отмеченное качеством премиальных отрубов, изысканной обстановкой и вниманием к каждой детали.',
        },
      ],
    },
    zh: {
      ...
      events: [
        {
          ...
          title: '铭刻于心的庆典',
          description:
            '难得的日子，理应配以专属空间。我们以专属菜单、个性化布置与卓越服务，为生日与婚礼营造完美氛围，让每个特别时刻熠熠生辉。',
        },
        {
          label: '企业活动',
          title: '企业晚宴与会议',
          description:
            '从高管晚宴到商务会议，我们提供最多容纳150人的独立空间，配备完善设施与无可挑剔的服务，菜单可依据不同商务场合量身定制。',
        },
        {
          label: '特别庆典',
          title: '值得至臻呈现的时刻',
          description:
            '无论何种场合，我们都以优质肉切的品质、精致的环境与对每一细节的悉心打磨，承诺一段难忘的体验。',
        },
      ],
    },
  };
